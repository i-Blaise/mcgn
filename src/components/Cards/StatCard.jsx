export default function StatCard({ statImage, statNumber, statDescription }) {
    return (
        <div className='bg-[#FEF6E9] flex flex-col justify-center items-center p-8 w-[306px] h-[372px] md:w-[285px] md:h-[355px] hover:shadow-lg transition-shadow duration-300'>
