...
export default function ProjectCard() {
    return (
        <div className='flex flex-col gap-4 bg-white [box-shadow:0_10px_25px_rgba(37,42,52,0.08)] w-full border border-transparent transition-all duration-300 hover:border-[#BB7E1C] hover:[box-shadow:0_15px_35px_rgba(37,42,52,0.15)] cursor-pointer'>
            ...
            <div className='px-6 pb-8 h-60 flex flex-col gap-4'>
                <div>
